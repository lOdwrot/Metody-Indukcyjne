...
# optimal wine params
  ...
  mTreeParams <- C5.0Control(CF = 0.1, minCases = 5, noGlobalPruning = FALSE, winnow = TRUE)
  cTree <- C5.0(x = mDataSet[, mFeatureColumns], y = as.factor(mDataSet$Class), control=mTreeParams)
  mResult <- stratifiedCrossC50(mDataSet, mTreeParams, 9)
  print(mResult$F1)
...
resC <- c(0.932, 0.816, 0.691)
resB <- c(0.957, 0.748, 0.646)

d <-data.frame(c5_0 = resC, bayes = resB)
